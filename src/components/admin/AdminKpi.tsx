...
import type { AdminHealthBand } from "@/types/admin";

const BAND_TONE: Record<AdminHealthBand, string> = {
...
const BAND_LABEL: Record<AdminHealthBand, string> = {
  HEALTHY: "Healthy",
  DEGRADED: "Degraded",
  CRITICAL: "Critical",
  UNKNOWN: "Unknown",
...
/**
 * Premium administration KPI tile. Renders "Awaiting Live Data" whenever the
 * metric is null — the card never invents a figure.
 */
